package org.wso2.ballerina.twitterSummary.connectors;
...
public connector ClientConnector (string consumerKey, string consumerSecret, string accessToken, string accessTokenSecret) {
    ...
    action getUserTimelineStatuses() (http:Response, http:HttpConnectorError) {
        ...
        http:Response response = {};
        map parameters = {};
        string tweetPath = "/1.1/statuses/user_timeline.json";
    ...
    action getUserFollowers() (http:Response, http:HttpConnectorError) {
        ...
        http:Response response = {};
        map parameters = {};
        string tweetPath = "/1.1/followers/list.json";
    ...
    action getUserFollowingFriends() (http:Response, http:HttpConnectorError) {
        ...
        http:Response response = {};
        map parameters = {};
        string tweetPath = "/1.1/friends/list.json";
